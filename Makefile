...
#     NO_META => q[1]
#     PREREQ_PM => { Test::More=>q[0.52], Math::BigInt=>q[0], ExtUtils::MakeMaker=>q[6.36], Class::Accessor=>q[0], constant=>q[0], Config=>q[0], Parse::RecDescent=>q[1.94] }
#     TEST_REQUIRES => {  }
#     VERSION => q[5.05]
...
DISTVNAME = Google-ProtocolBuffers-0.09
